...
{
    public class FakeHouseProjectDbContext : IdentityDbContext<ApplicationUser>, IHouseProjectDbContext
    {
        private readonly FakeUserContextAccessor _userResolverService;

        public FakeHouseProjectDbContext(DbContextOptions<FakeHouseProjectDbContext> options, FakeUserContextAccessor userResolverService) : base(options)
        {
